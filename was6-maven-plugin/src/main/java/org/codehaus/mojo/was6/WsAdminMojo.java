    ...
    extends AbstractWas6Mojo
{
    ...
    /**
     * Escape special \ character by \\ in args passed to the scrip.
     * 
     * @parameter expression="${was6.escapeSpecialCharactersInArgs}"  default-value=false
     * @since 1.2
     */
    private boolean escapeSpecialCharactersInArgs;
        ...
        throws MojoExecutionException
    {
        ...
        if ( args != null )
        {
            ...
            {
                String value = args[i];
                if(escapeSpecialCharactersInArgs){
